...
public final class ActivityThirdBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialToolbar toolbarThird;

  private ActivityThirdBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvNotes,
      @NonNull MaterialToolbar toolbarThird) {
    this.rootView = rootView;
    this.rvNotes = rvNotes;
    this.toolbarThird = toolbarThird;
  }
  ...
  public static ActivityThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.toolbarThird;
      MaterialToolbar toolbarThird = ViewBindings.findChildViewById(rootView, id);
      if (toolbarThird == null) {
        break missingId;
      }

      return new ActivityThirdBinding((ConstraintLayout) rootView, rvNotes, toolbarThird);
    }
