...
public final class ItemNoteBinding implements ViewBinding {
  ...
  private ItemNoteBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivPhoto,
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNoteBinding((MaterialCardView) rootView, ivPhoto, tvDate, tvTitle);
    }
